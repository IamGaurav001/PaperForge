  ...
  return (
    <>
      ...
      <div className={`
        ...
        flex print:hidden w-[290px] h-full bg-white md:rounded-[32px] shadow-2xl md:shadow-2xl flex-col shrink-0
      `}>
      {/* Logo */}
      ...
      {/* Action Button */}
      <div className="px-6 mt-8 shrink-0 flex justify-center">
        <Link href="/create" onClick={() => setSidebarOpen(false)} className="block w-full group cursor-pointer">
          <div className="w-full h-[44px] rounded-full bg-gradient-to-b from-[#F48F60] to-[#CD462F] p-[2px] shadow-[0_4px_12px_-4px_rgba(205,70,47,0.4)] transition-all duration-300 group-hover:shadow-[0_6px_16px_-4px_rgba(205,70,47,0.5)] group-hover:scale-[1.02] group-active:scale-[0.98]">
      ...
      {/* Navigation */}
      <nav className="flex-1 px-5 mt-8 space-y-2 overflow-y-auto">
        {navItems.map((item) => {
      ...
      {/* Bottom Section */}
      <div className="px-5 pb-5 shrink-0 pt-4">
